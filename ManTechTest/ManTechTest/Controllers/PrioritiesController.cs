...
namespace ManTechTest.Controllers
{
    public class PrioritiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PriorityId,Priority1,PriorityLevel")] Priority priority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PriorityId,Priority1,PriorityLevel")] Priority priority)
        {
            if (ModelState.IsValid)
            {
